...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.neu.opportunitymanagement");
...
//        String templatePath = "/templates/mapper.xml.ftl";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/src/main/resources/com/neu/opportunitymanagement/" + pc.getModuleName() + "/mapper"
        ...
        cfg.setFileCreate(new IFileCreate() {
            ...
            public boolean isCreate(ConfigBuilder configBuilder, FileType fileType, String filePath) {
                ...
                if (fileType == FileType.MAPPER) {
                    // The mapper file has been generated and judged to exist, if you don’t want to regenerate, return false
